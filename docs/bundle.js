...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_msr__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_msr___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_msr__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gumadapter__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gumadapter___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_gumadapter__);
...
class Recorder {
  ...
  start() {
    ...
    return _asyncToGenerator(function* () {
      _this.stream = yield navigator.mediaDevices.getUserMedia({ audio: true });

      _this.recorder = new __WEBPACK_IMPORTED_MODULE_0_msr___default.a(_this.stream);
      _this.recorder.mimeType = AUDIO_MIME;

      _this.recorder.ondataavailable = function (blob) {
...
const recorder = new __WEBPACK_IMPORTED_MODULE_0__recorder__["a" /* default */]();

// initial state
stopBtn.classList.add('hidden');

// start
startBtn.addEventListener('click', _asyncToGenerator(function* () {
...
// stop
stopBtn.addEventListener('click', _asyncToGenerator(function* () {
  recorder.stop();
  stopBtn.classList.add('hidden');

  const links = recorder.blobs.map(function (blob, index) {
